<?php
// =====================================
// INICIO DE LÓGICA PHP (INTACTA)
// =====================================
include 'includes/conexion.php';
include 'includes/header.php'; // Esto incluye el <head> y el <nav>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 hero-text">
                <h1 class="display-3 fw-bold">
                    ¡Conquista el Hambre, Domina el Sabor!
                </h1>
                <p class="lead my-4">
                    Embárcate en un viaje de sabor donde tu hambre obedece y cada bocado declara tu regla culinaria.
                </p>
                <a href="#restaurantes-section" class="btn btn-order-now btn-lg">
                    ¡Pide ahora!
                </a>
            </div>
