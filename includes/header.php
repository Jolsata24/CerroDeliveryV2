...
<body>
    <div id="preloader">
        <img src="<?php echo $ruta_base; ?>assets/img/loader.gif" alt="Cargando..." style="width: 60px;">
    </div>

    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo $ruta_base; ?>index.php">
                <img src="<?php echo $ruta_base; ?>assets/img/logo.png" alt="CerroDelivery" style="height: 45px; filter: brightness(0) invert(1);">
            </a>
                    ...
                    <?php if (isset($_SESSION['cliente_id'])): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?php echo $ruta_base; ?>mis_pedidos.php">Mis Pedidos</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item text-danger" href="<?php echo $ruta_base; ?>procesos/logout_cliente.php">Cerrar Sesión</a></li>
                            </ul>
                        </li>
                    <?php else: ?>
